...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <div class="col-auto">
                            <a href="dentist-form.php" class="d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                    ...
                    <div class="card shadow mb-4">
                        <div class="d-flex card-header py-3 justify-content-between">
                            <h6 class="m-0 font-weight-bold text-primary">Listagem de Dentistas</h6>
                                ...
                                <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            $json = requestApi('GET', 'http:/localhost:8080/dentists/list/' . $status, false, $_SESSION['token']);
                                            $data = json_decode($json);
                                            ...
                                            foreach ($data as $key => $value){
                                                ...
                                                echo "<tr>
                                                        ...
                                                        <td class='text-center'> 
                                                            ...
                                                            <a href='dentist-edit.php?id=" . $value->userId . "&name=" . $value->name . "&surname=" . $value->surname . "&document=" . $value->document . "&email=" . $value->email . "&telephone=" . $value->telephone . "&cellphone=" . $value->cellphone . "&expertise=" . $value->expertise . "' class='btn btn-sm btn-warning'><i class='fas fa-pen'></i></a>
                                                            " . $workaround . "
                                                        </td>
                                                    </tr>";
                                            }
            ...
            echo "
                <div class='modal fade' id='detailModal" . $value->userId . "' tabindex='-1' role='dialog' aria-labelledby='exampleModalLabel'
                    ...
                    <div class='modal-dialog' role='document'>
                        <div class='modal-content'>
                            <div class='modal-header'>
                                <h5 class='modal-title' id='exampleModalLabel'>Detalhes do Dentista</h5>
                                <button class='close' type='button' data-dismiss='modal' aria-label='Close'>
                                    <span aria-hidden='true'>×</span>
                                </button>
                            </div>
                            <div class='modal-body'>
                                ...
                                <div class='mb-3 col-12 col-md-12'>
                                    <label for='document' class='form-label'>CRO</label>
                                    <input type='text' class='form-control' id='document' value='" . $value->document . "' disabled>
                                </div>
                                <div class='mb-3 col-12 col-md-12'>
                                    <label for='expertise' class='form-label'>Expertise</label>
                                    <input type='text' class='form-control' id='expertise' value='" . $value->expertise . "' disabled>
                                </div>
                                <div class='mb-3 col-12 col-md-12'>
                            ...
                            <div class='modal-footer'>
                                <a href='dentist-edit.php?id=" . $value->userId . "&name=" . $value->name . "&surname=" . $value->surname . "&document=" . $value->document . "&email=" . $value->email . "&telephone=" . $value->telephone . "&cellphone=" . $value->cellphone . "&expertise=" . $value->expertise. "' class='btn btn-primary'>Editar</a>
                            </div>
                        </div>
                    </div>
                </div>";
    ...
    <script>
        function status(){
            if (<?= $status ?> == false){
                window.location='dentist-list.php';
            } else {
                window.location='dentist-list.php?status=false';
            }
        }
    </script>
